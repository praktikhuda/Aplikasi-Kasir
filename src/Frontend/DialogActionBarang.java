 ...
 * @author lenovo
 */
public class DialogActionBarang extends javax.swing.JDialog {
    private java.awt.Frame parent;
    private TableBarang tb;
    /**
     * Creates new form DialogTest
     */
    public DialogActionBarang(java.awt.Frame parent, boolean modal, TableBarang tb) {
        super(parent, modal);
        initComponents();
        this.parent = parent;
        this.tb = tb;
    ...
    private DialogActionBarang(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jtNama.setFont(new java.awt.Font("MS UI Gothic", 1, 14)); // NOI18N
        jtNama.setPreferredSize(new java.awt.Dimension(300, 35));

        jLabel4.setFont(new java.awt.Font("MS UI Gothic", 1, 18)); // NOI18N
        jLabel4.setText("Harga");

        jtHarga.setFont(new java.awt.Font("MS UI Gothic", 1, 14)); // NOI18N
        jtHarga.setPreferredSize(new java.awt.Dimension(300, 35));

        jLabel5.setFont(new java.awt.Font("MS UI Gothic", 1, 18)); // NOI18N
        jLabel5.setText("Stok");

        jtStok.setFont(new java.awt.Font("MS UI Gothic", 1, 14)); // NOI18N
        jtStok.setPreferredSize(new java.awt.Dimension(300, 35));

        jbTambah.setFont(new java.awt.Font("MS UI Gothic", 1, 14)); // NOI18N
        jbTambah.setText("Tambah Barang");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addComponent(jtHarga, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGap(50, 50, 50)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jtNama, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jtStok, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void jbTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbTambahActionPerformed
        ...
        tb.setId_barang(jtId.getText());
        tb.setNama(jtNama.getText());
        tb.setHarga(Integer.parseInt(jtHarga.getText()));
        tb.setStok(Integer.parseInt(jtStok.getText()));
        int hasil = tb.tambah();
        if(hasil ==1){
    ...
    private void jbUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbUbahActionPerformed
        ...
        int hasil = tb.ubah(id, nama, harga, stok);
        if(hasil ==1){
            System.out.println("berhasil");
        }else{
            System.out.println("Gagal");
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        // TODO add your handling code here:
        jtId.setText(tb.getId_barang());
        jtNama.setText(tb.getNama());
        jtHarga.setText(String.valueOf(tb.getHarga()));
        jtStok.setText(String.valueOf(tb.getStok()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogActionBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogActionBarang dialog = new DialogActionBarang(new javax.swing.JFrame(), true);
