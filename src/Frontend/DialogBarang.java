...
public class DialogBarang extends javax.swing.JDialog {
    ...
    public void tampil(){
        ...
        String[] namaKolom = new String[] {"Id Barang", "Nama Barang", "Harga", "Stok"};

        ArrayList<Object[]> listData = tb.getSemua();
    ...
    private void jbTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbTambahActionPerformed
        ...
        TableBarang tb = new TableBarang();
        DialogActionBarang da = new DialogActionBarang(parent, true, tb);
        da.setVisible(true);
